...
//----------------------------------------------------------------------------------------------------------------------
    ...
    static Stream<Arguments> getOptionsArguments() {
        return Stream.of(
                Arguments.of(new TestClass(), "testValue", new JSONObject("{}"),                           null, new JSONObject("{}")),
                Arguments.of(new TestClass(), "testValue", new JSONObject("{\"a\": 1, \"b\": 2}"),         null, new JSONObject("{\"a\": 1, \"b\": 2}")),
                Arguments.of(new TestClass(), "testValue", new HashMap<>(),                                null, new JSONObject("{}")),
                Arguments.of(new TestClass(), "testValue", new JSONObject("{\"a\": 1, \"b\": 2}").toMap(), null, new JSONObject("{\"a\": 1, \"b\": 2}")),
                Arguments.of(new TestClass(), "testValue", null,                                           null, new JSONObject()),
                Arguments.of(new TestClass(), "testValue", "_nullValue",                                   null, new JSONObject())
        );
    }
