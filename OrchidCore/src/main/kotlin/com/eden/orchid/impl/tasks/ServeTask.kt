...
@Description(
    "Makes it easier to create content for your Orchid site by watching your resources for changes and " +
...
class ServeTask : OrchidTask("serve", TaskService.TaskType.SERVE) {
