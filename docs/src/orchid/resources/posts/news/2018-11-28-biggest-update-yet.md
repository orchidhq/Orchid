...
- Wikis can now generate PDFs for offline documentation. See documentation [here](https://orchidhq.github.io/Orchid/plugins/orchid-wiki-feature#offline-documentation).
- A new Asset Manager improves build times, and intelligently renders your image assets. It even includes basic image manipulation for automated thumbnail generation! Learn more about media management [here](https://orchidhq.github.io/Orchid/wiki/user-manual/content-management/media).
...
- Pebble is the main template engine used by Orchid, and [pebbletemplates.io](https://pebbletemplates.io/) was officially launched on November 11. Some of the most notable Orchid features it uses are:
  - [Editorial](https://orchidhq.github.io/Orchid/themes/orchid-editorial-theme) theme
  - [Changelogs](https://orchidhq.github.io/Orchid/plugins/orchid-changelog-feature) and [automated Github releases](https://orchidhq.github.io/Orchid/wiki/user-manual/publication/github-releases)
  - [Wiki](https://orchidhq.github.io/Orchid/plugins/orchid-wiki-feature) with offline documentation
  - [Javadocs](https://orchidhq.github.io/Orchid/plugins/orchid-javadoc-feature) Java source code documentation
  - Deployment to [Github Pages](https://orchidhq.github.io/Orchid/wiki/user-manual/publication/github-pages)
- Strikt is a new assertion library for Kotlin, and [strikt.io](https://strikt.io/) went live October 19th using the following Orchid features:
  ...
  - [Changelogs](https://orchidhq.github.io/Orchid/plugins/orchid-changelog-feature)
  - [Wiki](https://orchidhq.github.io/Orchid/plugins/orchid-wiki-feature)
  - [Kotlindocs](https://orchidhq.github.io/Orchid/plugins/orchid-kotlindoc-feature) Kotlin source code documentation
  - Deployment to [Github Pages](https://orchidhq.github.io/Orchid/wiki/user-manual/publication/github-pages)

In addition, my personal website at [caseyjbrooks.com](https://www.caseyjbrooks.com/) got a major facelift. It previously used the [FutureImperfect](https://orchidhq.github.io/Orchid/themes/orchid-future-imperfect-theme) theme, but I have been working on creating a custom theme based on Bulma, with some very helpful advice from @aspittel's [Profile Advice Thread](https://dev.to/aspittel/portfolio-advice-thread-56g9). When the theme is finished, it will be merged into the main Orchid repo, so you can use it for your Orchid sites too!
