...
class OrchidPluginHelpers {
    ...
    public static HashMap<String, String> getOrchidProjectArgsMap(Project project, String defaultTask, boolean forceTask) {
        ...
        projectArgs.put "resourcesDir", getPropertyValue(project, 'srcDir', project.sourceSets.orchidDocs.resources.srcDirs[0].toString())
        projectArgs.put "d",            getPropertyValue(project, 'destDir', project.buildDir.absolutePath + '/docs/javadoc')
