...
object Libs {
  const val american_bible_society_client: String =
      "com.github.JavaEden:American-Bible-Society-Client:" + Versions.american_bible_society_client
  ...
  const val flexmark_ext_enumerated_reference: String =
      "com.vladsch.flexmark:flexmark-ext-enumerated-reference:" + Versions.com_vladsch_flexmark
   ...
   * https://github.com/vsch/flexmark-java
   */
  const val flexmark_ext_gfm_tasklist: String = "com.vladsch.flexmark:flexmark-ext-gfm-tasklist:" +
      Versions.com_vladsch_flexmark
   ...
   * http://www.jython.org/
   */
  const val jython_standalone: String = "org.python:jython-standalone:" + Versions.jython_standalone
   ...
   */
  const val hamcrest_library: String = "org.hamcrest:hamcrest-library:" + Versions.hamcrest_library
   ...
   * https://copper-leaf.github.io/kodiak
   */
  const val swiftdoc_runner: String = "com.eden.kodiak:swiftdoc-runner:" + Versions.com_eden_kodiak
