...
class SourcedocFlags : OrchidFlag() {
    ...
    @JvmField
    @Deprecated("This is now the default, and the flag is ignored. If you have not migrated from the older " +
            "sourcedocs plugins, you can continue using them with `--legacySourceDoc`, but they will be removed " +
            "entirely in the next major release, 0.22.0.", replaceWith = ReplaceWith("!legacySourceDoc"))
